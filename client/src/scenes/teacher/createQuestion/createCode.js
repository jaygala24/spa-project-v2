                        ...
                        <Grid style={{marginTop: 40}} spacing={4} container direction='row' justify='center'>
                            <Grid item xs={12}>
                                ...
                                <div style={{...this.styles.font,fontSize: 16, letterSpacing: 1}} >
                                    Note: The question seen by the students during the test will be exactly same as the one entered below; Including whitespaces and special characters
                                </div>
                            </Grid>
                            <Grid item xs={12} style={{border: '1px #797979 solid', borderRadius: 8}} >
                            <Editor
                            ...
                            <Grid item xs={6} >
                                <Button style={{...this.styles.btn, marginTop: 10, marginBottom: 40, width: '100%'}} onClick={this.createQuestion} variant='contained' color='primary'>
                                    Create Question
                                </Button>
                            </Grid>
                        </Grid>
